...
function getReminderOffset(reminderTime) {
  ...
  const text = String(reminderTime).toLowerCase();

  if (text.includes("same with due date")) return 0;
  if (text.includes("5 minutes")) return -5;
  if (text.includes("15 minutes")) return -15;
  if (text.includes("30 minutes")) return -30;
  if (text.includes("1 day")) return -1440;
